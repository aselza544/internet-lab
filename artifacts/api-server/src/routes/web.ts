...
function cspHeader(proxyOrigin: string): string { return `default-src 'none'; style-src ${proxyOrigin} 'unsafe-inline'; img-src ${proxyOrigin} data: blob:; font-src ${proxyOrigin} data:; script-src ${proxyOrigin} 'unsafe-inline' 'unsafe-eval'; connect-src ${proxyOrigin}; media-src ${proxyOrigin} blob:; frame-src ${proxyOrigin}; child-src ${proxyOrigin}; worker-src ${proxyOrigin} blob:; object-src 'none'; base-uri 'none'; form-action ${proxyOrigin}; frame-ancestors 'none';`; }
